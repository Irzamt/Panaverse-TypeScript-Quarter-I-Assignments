...
/****************************************************************************************************************** */
let shoppingCart = [];
function shoppingAdd(item, quantity) {
...
function shoppingUpdate(item, quantity, id) {
